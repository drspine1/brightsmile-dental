...
export default function WhyUs() {
  return (
    <section id="why-us" className=" mt-40 md:px-6 max-w-6xl mx-auto text-center  bg-white text-gray-900 w-[90%] ">
     ...
     <motion.p
            ...
            viewport={{once:true}}
            transition={{ duration: 0.6, delay: 0.2 }}
            className=" leading-relaxed  text-gray-800 mb-10 max-w-2xl mx-auto text-lg"
          >
            At <span className="font-bold text-blue-700">BrightSmile Dental Clinic</span>,
            we’re committed to making every smile shine — combining expertise, comfort, and compassion.
          </motion.p>
